// Stardew Valley Mouse Trail
// Replaces the blue squares with "Pixel Dust" or "Spirit" particles
...
class Particle {
  constructor(x, y) {
    ...
    this.vy = random(-1, 1);
    this.alpha = 255;
    this.color = random() > 0.5 ? color(255, 215, 0) : color(61, 128, 50); // Gold or Green
