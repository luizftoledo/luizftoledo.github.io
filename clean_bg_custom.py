...
images_to_clean = [
    "images/stardew/junimos_group.png",
    "images/persona/treasure_chest.png",
    "images/persona/calling_card.png",
    "images/pokemon/rare_candy.png",
    "images/pokemon/pokemon_avatar_trainer_final.png"
]
